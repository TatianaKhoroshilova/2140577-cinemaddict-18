...
const createFilmDetailsViewTemplate = ({filmInfo}) => {
  const {
    title, alternativeTitle, totalRating, poster, ageRating, director, writers, actors, date, release, runtime, genre,description
  } = filmInfo;
      ...
      <ul class="film-details__comments-list">
        <li class="film-details__comment">
          <span class="film-details__comment-emoji">
            <img src="./images/emoji/${getRandomValue(emotions)}.png" width="55" height="55" alt="emoji-${getRandomValue(emotions)}">
          </span>
          <div>
            <p class="film-details__comment-text">${getRandomValue(comment)}</p>
            <p class="film-details__comment-info">
              <span class="film-details__comment-author">${getRandomValue(authors)}</span>
...
export default class FilmDetailsView {
  ...
  getTemplate() {
    return createFilmDetailsViewTemplate(this.film, this.elements);
  }
